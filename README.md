...
- [x] Mention two parts of Express that you learned about this week.
  ...
  - Routers - keeping code tidy be seperating requests to their respective subroutes (i.e. actions and projects)

- [x] Describe Middleware?
  - A function/piece of software that runs between the invocation and body of a function or which acts as a bridge between functions/software

- [x] Describe a Resource?
  - A resource is anything which is hosted by, or otherwise passed from, a server to a client. Examples can include web pages, images, user data, and much more.

- [x] What can the API return to help clients know if a request was successful?
  - A response code, traditionally a 200 level response code.

- [x] How can we partition our application into sub-applications?
  - Broadly worded question but modules, components, and routers are ways we can divide an application into sub-applications.
